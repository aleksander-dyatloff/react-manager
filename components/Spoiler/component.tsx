...
const Component: FC<PropsWithChildren<Props>> = ({
  ...
  return (
    <div className={styles.wrapper}>
      <button onClick={() => setIsOpen(!isOpen)} className={classNames(styles.header, isOpen && styles.headerVariant.isActive)}> 
        <span>{title}</span>
        <svg className={classNames(styles.icon, isOpen && styles.iconVariant.isActive)} fill="currentColor" viewBox="0 0 24 24">
